...
D. A web application firewall is the best solution for protecting an SaaS application from layer 7 attacks such as script injection, buffer overflow, and reflected cross-site scripting.
